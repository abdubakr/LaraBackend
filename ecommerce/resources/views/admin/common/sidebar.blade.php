    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview {{ Request::is('admin/dashboard/this_month') ? 'active' : '' }}">
          ...
          <li class="treeview {{ Request::is('admin/listingCategories') ? 'active' : '' }} {{ Request::is('admin/addCategory') ? 'active' : '' }}
          {{ Request::is('admin/editCategory/*') ? 'active' : '' }}
          {{ Request::is('admin/listingSubCategories') ? 'active' : '' }}
          ...
          {{ Request::is('admin/editSubCategory/*') ? 'active' : '' }}">
              ...
              <ul class="treeview-menu">
                  <li class="{{ Request::is('admin/affiliate/network') ? 'active' : '' }}">
                      <a href="{{ URL::to('admin/affiliate/network')}}"><i class="fa fa-circle-o">

                          </i> Network </a></li>
                  <li class="{{ Request::is('admin/affiliate/commissions') ? 'active' : '' }}">
                      <a href="{{ URL::to('admin/affiliate/commissions')}}"><i class="fa fa-circle-o"></i> Commessions</a></li>

                  <li class="{{ Request::is('admin/affiliate/registration-points') ? 'active' : '' }}">
                      <a href="{{ URL::to('admin/affiliate/registration-points')}}"><i class="fa fa-circle-o"></i>
