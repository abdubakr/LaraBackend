...
Route::group(['prefix' => 'admin'], function () {
	...
	Route::group(['namespace' => 'Admin'], function () {
		...
		*/
            ...
            //ecom affiliate
            Route::get('/affiliate/network', 'AdminAffiliateController@network');
            Route::get('/affiliate/commissions', 'AdminAffiliateController@commissions');
            Route::get('/affiliate/registration-points', 'AdminAffiliateController@registration_points');
