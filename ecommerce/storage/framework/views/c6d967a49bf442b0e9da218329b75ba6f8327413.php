    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview <?php echo e(Request::is('admin/dashboard/this_month') ? 'active' : ''); ?>">
          ...
          <!-- Start Ecom Affiliate -->
          <li class="treeview <?php echo e(Request::is('admin/listingCategories') ? 'active' : ''); ?> <?php echo e(Request::is('admin/addCategory') ? 'active' : ''); ?>

          <?php echo e(Request::is('admin/editCategory/*') ? 'active' : ''); ?>

          <?php echo e(Request::is('admin/listingSubCategories') ? 'active' : ''); ?>

          <?php echo e(Request::is('admin/addSubCategory') ? 'active' : ''); ?>

          <?php echo e(Request::is('admin/editSubCategory/*') ? 'active' : ''); ?>">
              <a href="#">  <i class="fa fa-bars" aria-hidden="true"></i><span> Affiliate </span>
                  <i class="fa fa-angle-left pull-right"></i>          </a>

              <ul class="treeview-menu">
                  <li class="<?php echo e(Request::is('admin/affiliate/network') ? 'active' : ''); ?>">
                      <a href="<?php echo e(URL::to('admin/affiliate/network')); ?>"><i class="fa fa-circle-o">

                          </i> Network </a></li>
                  <li class="<?php echo e(Request::is('admin/affiliate/commissions') ? 'active' : ''); ?>">
                      <a href="<?php echo e(URL::to('admin/affiliate/commissions')); ?>"><i class="fa fa-circle-o"></i> Commessions</a></li>

                  <li class="<?php echo e(Request::is('admin/affiliate/registration-points') ? 'active' : ''); ?>">
                      <a href="<?php echo e(URL::to('admin/affiliate/registration-points')); ?>"><i class="fa fa-circle-o"></i>
                          Registration points</a></li>
              </ul>
          </li>
          <!-- END Ecom Affiliate -->
