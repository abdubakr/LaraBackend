            ...
            <div class="row">
              <div class="col-xs-12">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <?php $__currentLoopData = $result['orders_status']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$OrderStatus): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td><?php echo e($OrderStatus->orders_status_id); ?></td>
                            <td><?php echo e($OrderStatus->orders_status_name); ?></td>
                            <td><?php echo e($OrderStatus->name); ?></td>
                            ...
                            <a data-toggle="tooltip" data-placement="bottom" title="<?php echo e(trans('labels.Delete')); ?>" id="deleteOrderStatusId" orders_status_id ="<?php echo e($OrderStatus->orders_status_id); ?>" class="badge bg-red"><i class="fa fa-trash" aria-hidden="true"></i></a>
                           </td>
                        </tr>
	...
	<div class="modal fade" id="deleteOrderStatusModal" tabindex="-1" role="dialog" aria-labelledby="deleteOrderStatusModalLabel">
	  <div class="modal-dialog" role="document">
		<div class="modal-content">
		  ...
		  <?php echo Form::open(array('url' =>'admin/deleteOrderStatus', 'name'=>'deleteOrderStatus', 'id'=>'deleteOrderStatus', 'method'=>'post', 'class' => 'form-horizontal', 'enctype'=>'multipart/form-data')); ?>
