...
<div class="content-wrapper"> 
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="<?php echo e(URL::to('admin/listingCoupons')); ?>"><i class="fa fa-tablet"></i><?php echo e(trans('labels.ListingAllCoupons')); ?></a></li>
                        ...
                        <!-- form start -->                        
                         <div class="box-body">
							...
							<div class="box-footer text-center">
								...
								<a href="<?php echo e(URL::to('admin/listingCoupons')); ?>" type="button" class="btn btn-default"><?php echo e(trans('labels.back')); ?></a>
							</div>
                              <!-- /.box-footer -->
                            <?php echo Form::close(); ?>
