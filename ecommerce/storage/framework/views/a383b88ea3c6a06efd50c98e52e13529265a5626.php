...
<div class="content-wrapper"> 
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="<?php echo e(URL::to('admin/listingSubCategories')); ?>"><i class="fa fa-bars"></i><?php echo e(trans('labels.SubCategories')); ?></a></li>
                            ...
                            <?php echo Form::open(array('url' =>'admin/addNewSubCategory', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')); ?>
                              ...
                              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <!--<div class="form-group">
                                  ...
                                  <div class="col-sm-10 col-md-4">
                                    <?php echo Form::text('categoryName',  '', array('class'=>'form-control', 'id'=>'categoryName')); ?>
                              ...
                              <div class="box-footer text-center">
                                ...
                                <a href="<?php echo e(URL::to('admin/listingSubCategories')); ?>" type="button" class="btn btn-default"><?php echo e(trans('labels.back')); ?></a>
                              </div>
                              <!-- /.box-footer -->
                            <?php echo Form::close(); ?>
