        ...
        <div class="box">
          <div class="box-header">
            ...
            <div class="box-tools pull-right">
            	<a href="addNews" type="button" class="btn btn-block btn-primary"><?php echo e(trans('labels.AddNews')); ?></a>
            </div>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
                   ...
                   <?php if(count($news)>0): ?>
                    <?php $__currentLoopData = $news; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$new): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <a data-toggle="tooltip" data-placement="bottom" title="<?php echo e(trans('labels.Yes')); ?>Edit" href="editNews/<?php echo e($new->news_id); ?>" class="badge bg-light-blue"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a> 
                                
                                <a data-toggle="tooltip" data-placement="bottom" title="<?php echo e(trans('labels.Yes')); ?>Delete" id="deleteNewsId" news_id="<?php echo e($new->news_id); ?>" class="badge bg-red"><i class="fa fa-trash" aria-hidden="true"></i></a>
                            </td>
                        </tr>
